...
//		Draw properties
		...
		g.drawString("Damage: "+tower.getDamage(), x+height+50, y+40);
		g.drawString("Range: "+tower.getRange(), x+height+50, y+80);
		g.drawString("Firerate: "+tower.getFireRate(), x+height+50, y+120);
